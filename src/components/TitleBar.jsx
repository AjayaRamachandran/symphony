        ...
        {isMac && (
          <div className={`mac-controls ${!isFocused ? 'unfocused' : ''}`}>
            <div className="mac-buttons">
              <span className="mac-btn close" onClick={() => window.electronAPI.close()} />
              <span className="mac-btn minimize" onClick={() => window.electronAPI.minimize()} />
              <span className="mac-btn maximize" onClick={() => window.electronAPI.maximize()} />
            </div>
          </div>
        )}
