  ...
  useEffect(() => {
    const handler = async (e) => {
      if (e.key === "Backspace" || e.key === "Delete") {
        if (!isFieldSelected) setShowDeleteConfirm(true);
        console.log(isFieldSelected);
      }
    };
    ...
    <>
      ...
      >
        <DeleteConfirmationModal
          ...
          action={"Delete"}
          modifier={selectingSymphony ? "Symphony" : "file"}
        />
      </GenericModal>
